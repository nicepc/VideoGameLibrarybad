...
namespace VideoGameLibrary.Controllers
{
    public class CollectionController : Controller
    {
        private static List<VideoGame> videoGameCollection = new List<VideoGame>
        {
            ...
            new VideoGame("/img/terraria.jpeg", "Terraria", "Action Adventure", 2011, "T", "Nintendo Switch"),
            new VideoGame("/img/wizardOfLegend.webp", "Wizard of Legend", "Roguelike Indie", 2018, "E", "Steam")
